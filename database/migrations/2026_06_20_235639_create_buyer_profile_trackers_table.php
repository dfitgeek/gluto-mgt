...
return new class extends Migration
{
    ...
    {
        Schema::create('buyer_profile_trackers', function (Blueprint $table) {
            $table->id();

            // Relationships
            $table->foreignId('buyer_profile_id')->nullable()->constrained('buyer_profiles')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('buyer_profile_trackers');
    }
};

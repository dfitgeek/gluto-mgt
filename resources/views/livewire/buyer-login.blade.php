    ...
    <div class="space-y-8 bg-white shadow-xl p-8 border rounded-[2.5rem] border-outline-variant/60 w-full max-w-md animate-fadeIn">
        ...
        <div class="text-center">
            <div class="flex justify-center items-center bg-primary/10 mx-auto mb-4 rounded-2xl w-12 h-12 text-primary">
                <span class="text-[28px] material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">shopping_bag</span>
            </div>
            <h2 class="font-headline-lg font-bold text-primary text-2xl tracking-tight">Enterprise Buyer Access</h2>
            <p class="mt-1.5 font-body-sm text-on-surface-variant text-sm">Sign in with your authorized representative credentials to access your procurement pipelines.</p>
        </div>
        ...
        <form wire:submit.prevent="login" class="space-y-5 mt-8">
            ...
            <div class="flex justify-between items-center pt-1 pl-1">
                <label class="flex items-center gap-2.5 cursor-pointer select-none">
                    ...
                    <span class="font-semibold text-on-surface-variant text-xs">Remember my procurement session</span>
                </label>
            </div>
        ...
        <div class="mt-6 pt-5 border-t border-outline-variant/40 text-center">
            <p class="text-[11px] text-on-surface-variant/80 leading-relaxed">
                Authorized corporate channel platform. All procurement connections log and access protocol metadata tracks are saved natively under active audit tracking ledgers.
            </p>
        </div>

                        ...
                        <div class="flex md:flex-row flex-col justify-between items-center gap-4 bg-white p-6 border-t border-outline-variant select-none">
                            ...
                            <div class="flex flex-wrap items-center gap-2 w-full md:w-auto">
                                <a href="{{ route('admin.buyers.masquerade', ['id' => $selectedBuyer->id]) }}"
                                    ...
                                    Sign-In As Buyer proxy                     </a>

                                <a href="{{ route('admin.buyers.order',['id' => $selectedBuyer->id]) }}" class="flex justify-center items-center gap-1.5 bg-surface-container hover:bg-primary/10 px-4 py-2.5 rounded-xl font-bold text-primary text-xs transition-colors">
